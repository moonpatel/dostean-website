...
export default function Navbar() {
    ...
    return (
        <>
            <div className="h-16 md:h-14 w-screen"></div>
            <div className="bg-dark text-white/90 fixed w-screen z-50 top-0">
                <div className="flex justify-between items-center text-base h-16 md:h-14 font-bold p-2 mt-1">
                    ...
                    <ul className="hidden md:flex font-normal space-x-6 mr-10">
                        <NavLink className={linkStateFunctionPC} to="/home" >
                            <li className="pb-2 px-3 hover:text-primary-400">Home</li>
                        </NavLink>
                        <NavLink className={linkStateFunctionPC} to="/menu" >
                            <li className="pb-2 px-3 hover:text-primary-400">Menu</li>
                        </NavLink>
                        <NavLink className={linkStateFunctionPC} to="/gallery" >
                            <li className="pb-2 px-3 hover:text-primary-400">Gallery</li>
                        </NavLink>
                        <NavLink className={linkStateFunctionPC} to="/about-us" >
                            <li className="pb-2 px-3 hover:text-primary-400">About Us</li>
                        </NavLink>
                    </ul>
                </div>
                {(showNavbar) &&
